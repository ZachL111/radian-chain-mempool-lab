"""Regression checks for the radian-chain-mempool-lab casebook."""
...
from casebook.harness import assert_expected, radian_chain_mempool_lab_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(radian_chain_mempool_lab_summary(), assert_expected())
